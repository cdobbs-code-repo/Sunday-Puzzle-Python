...
def is_criminal(myword):
    ...
    try:
        ...
        pass#print("the troublesome word is " + myword)
    return ("criminal" in bar or "illegal" in bar or ("law" in bar and "break" in bar))
...
output = open("C:/Users/cdobb/Desktop/Python_stuff/sunday_puzzle/11_29_2008/criminal_words.txt","w")
...
for line in myfile:
    ...
    if not numbers and letts and len(line) > 3:
        ...
        if is_criminal(line): # and dictio.check(a+b) and dictio.check(d+e):
            output.write(line+"\n")
