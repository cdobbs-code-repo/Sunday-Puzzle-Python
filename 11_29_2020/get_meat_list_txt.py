...
output = open("C:/Users/cdobb/Desktop/Python_stuff/sunday_puzzle/11_29_2020/meat_list.txt","w")
...
for line in myfile:
    ...
    if is_myword_related_to_THIS(line,"meat"): # and dictio.check(a+b) and dictio.check(d+e):
        output.write(line+"\n")
